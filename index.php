  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="index.php" class="logo">
        ...
        <span class="logo-lg"><b>Beva</b>Shop</span>
      </a>
      ...
      <section class="sidebar">
        ...
        <div class="user-panel">
          <div class="pull-left image">
            <img  width="70px"heigt="70px" src="halaman_akun/images/<?php echo $_SESSION['gambar'] ?>" class="img-circle" alt="User Image">
          </div>
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li><a href="index.php?page=transaksi"><i class="fa fa-credit-card-alt"></i> <span> Transaksi</span></a></li>
          ...
          <li><a href="index.php?page=stok"><i class=" fa fa-database"></i> <span> Stok</span> </span></a></li>
          <?php }else{?>
          <!-- <li><a href="index.php?page=transaksi"><i class="fa fa-dollar"></i> <span>Transaksi</span></a></li> -->
          <li><a href="index.php?page=histori"><i class="fa fa-history "></i> <span> Riwayat Transaksi</span></a></li>
          <li><a href="index.php?page=barang"><i class="fa fa-archive "></i> <span> Barang</span></a></li>
          <li><a href="index.php?page=kategoribarang"><i class="fa fa-tags"></i> <span> Kategori Barang</span></a></li>
          <li><a href="index.php?page=stok"><i class="fa fa-database"></i> <span> Stok</span> </span></a></li>
          <li><a href="index.php?page=supplier"><i class="fa fa-address-card"></i> <span> Supplier</span> </span></a></li>
          <!-- <li><a href="index.php?page=aktivitas"><i class="fa fa-calendar"></i> <span>Aktivitas</span> </span></a></li> -->
          <li><a href="index.php?page=laporan"><i class="fa fa-book"></i> <span> Laporan</span> </span></a></li>
          <!-- <li><a href="index.php?page=grafik"><i class="fa fa-line-chart"></i> <span>Grafik</span> </span></a></li> -->
    ...
    <footer class="main-footer">
      <strong>Copyright &copy; 2020 Bevashop </li>.</strong> All rights
      reserved.
    </footer>
