            ...
            <form role="form" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <textarea required type="text" name="deskripsi" class="form-control" id="exampleInputPassword1" placeholder="Masukan Deskripsi Barang"></textarea>
                </div>
                <div class="form-group">
...
<?php
  ...
  ini_set('date.timezone', 'Asia/Jakarta');
    ...
    if(move_uploaded_file($temp_name,$destination)){
      ...
      $sql      = "INSERT INTO barang (id, id_kategori, nama, gambar, deskripsi) values ('$kode', '$kategori', '$nama', '$namafile', '$deskripsi')";
