...
<head>
	...
	<style>
		table {
			...
			table-layout:fixed;width: 470px;
		}
		table td {
...
ini_set('date.timezone', 'Asia/Jakarta');
        ...
        $nama = "Data Barang Masuk $datein.pdf";
        // echo '<img src = "../Berdiri.png">';
        echo '<b><div align="center">
       
        Data Barang Masuk '.$datein.'</div></b><br /><br />';
       ...
       where stok.tanggal='$date'"; // Tampilkan semua data transaksi diurutkan berdasarkan tanggal
