<?php
	include('../koneksi.php');
	$query = "SELECT stok.`id`, barang.`nama`, supplier.`nama` AS supplier, stok.`stok_masuk`,  stok.`stok_sekarang`,stok.`tanggal`,stok.`kadaluarsa`,stok.`harga`
    FROM stok
    JOIN barang
	...
	$header = array(
		...
		array("label"=>"KADALUARSA", "length"=>35, "align"=>"C"),
